...
export const PagesManager = ({ setCurrentView }) => {
  ...
  const defaultPages = [
    ...
    { id: 'page-5', title: 'What We Do', slug: '/what-we-do', status: 'Published', viewKey: 'what-we-do', lastModified: '2026-07-25', template: 'Capabilities' },
    { id: 'page-6', title: 'Core Services', slug: '/core-services', status: 'Published', viewKey: 'core-services', lastModified: '2026-07-24', template: 'Services' },
    { id: 'page-7', title: 'Services Catalog', slug: '/services', status: 'Published', viewKey: 'services', lastModified: '2026-07-24', template: 'Services' },
    { id: 'page-8', title: 'Brand Collaborations', slug: '/collaborations', status: 'Published', viewKey: 'brand-collaborations', lastModified: '2026-07-23', template: 'Brands' },
    { id: 'page-9', title: 'Campaigns Showcase', slug: '/campaigns', status: 'Published', viewKey: 'campaigns', lastModified: '2026-07-22', template: 'Campaigns' },
    { id: 'page-19', title: 'Product Launches & Innovations', slug: '/product-launches', status: 'Published', viewKey: 'product-launches', lastModified: '2026-07-29', template: 'ProductLaunches' },
    ...
    { id: 'page-11', title: 'Media & Gallery', slug: '/media-gallery', status: 'Published', viewKey: 'media-gallery', lastModified: '2026-07-20', template: 'Gallery' },
    { id: 'page-12', title: 'Client Testimonials', slug: '/testimonials', status: 'Published', viewKey: 'testimonials', lastModified: '2026-07-19', template: 'Testimonials' },
    { id: 'page-13', title: 'Events & Keynotes', slug: '/events', status: 'Published', viewKey: 'events', lastModified: '2026-07-18', template: 'Events' },
