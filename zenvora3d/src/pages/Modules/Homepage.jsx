...
export const Homepage = () => {
  ...
  const [expandedCards, setExpandedCards] = useState({
    ...
    projects: false, services: false, logos: false, whyChooseUs: false, gallery: false
  });
    ...
    <div className="flex flex-col gap-6 text-left relative pb-20">
      ...
      <div className="border-b border-zinc-800/80 pb-5 flex flex-col xl:flex-row xl:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <Button onClick={() => showToast("🚀 Public production server updated successfully. Page is Live!")} variant="primary" size="sm" className="bg-gradient-to-r from-luxury-gold to-luxury-darkgold text-black font-bold shadow-gold-glow">
             Publish Live
          </Button>
        </div>
      </div>
